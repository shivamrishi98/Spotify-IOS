...
final class PlayerControlsView:UIView {
    ...
    private let backButton:UIButton = {
        ...
        let image = UIImage(
            ...
            withConfiguration: UIImage.SymbolConfiguration.init(pointSize: 34, weight: .regular))
    ...
    private let playPauseButton:UIButton = {
        ...
        let image = UIImage(
            systemName: "pause",
            withConfiguration: UIImage.SymbolConfiguration.init(pointSize: 34, weight: .bold))
        button.setImage(image, for: .normal)
        return button
    }()
    ...
    override func layoutSubviews() {
        ...
        backButton.frame = CGRect(x: playPauseButton.left-buttonSize-80,
